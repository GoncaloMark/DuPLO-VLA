...
class DP3Encoder(nn.Module):
    def __init__(self, 
        ...
        self.task_latent_key = 'task_latent'  
        ...
        self.task_latent_dim = task_latent_dim if use_task_conditioning else 0
        if self.use_task_conditioning:
            cprint(f"[DP3Encoder] Task conditioning enabled with latent dim: {task_latent_dim}", "green")
        ...
        self.n_output_channels += output_dim + self.task_latent_dim
    ...
    def forward(self, observations: Dict) -> torch.Tensor:
        ...
        features_to_concat = [pn_feat, state_feat]
